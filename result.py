...
#draw figure
def evaluateFiguare(test):
    #call new function
    for sentence in test['sentences']:
        asp = sentence['aspects']
        pasp = sentence['preAspect']
    accuracy_score(np.asanyarray(asp), np.asanyarray(pasp))
...
def evaluate(test):
    ...
    # for each discussion
    for sentence in test['sentences']:
        allAsp = sentence['aspects']
        allPreAspect = sentence['preAspect']

        accuracy_score(np.asanyarray(allAsp), np.asanyarray(allPreAspect))
